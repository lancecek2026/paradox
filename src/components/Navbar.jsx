      ...
      >
        <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center bg-white/5 border border-white/10 rounded-xl p-1.5 gap-1 backdrop-blur-md">
            ...
            <a href="#" onClick={(e) => handleNavClick(e, 'about')} className="font-sans font-medium text-[13px] text-gray-300 hover:text-white hover:bg-white/5 px-5 py-2 rounded-lg transition-all tracking-wide">About</a>
            <a href="#" onClick={(e) => handleNavClick(e, 'events')} className="font-sans font-medium text-[13px] text-gray-300 hover:text-white hover:bg-white/5 px-5 py-2 rounded-lg transition-all tracking-wide">Events</a>
            <Link 
              to="/hackathon" 
            ...
            <a href="#" onClick={(e) => handleNavClick(e, 'schedule')} className="font-sans font-medium text-[13px] text-gray-300 hover:text-white hover:bg-white/5 px-5 py-2 rounded-lg transition-all tracking-wide">Schedule</a>
          </div>

          {/* Right: Action Button */}
          <div className="hidden lg:flex">
            <a href="#" onClick={(e) => handleNavClick(e, 'events')} className="bg-white hover:bg-gray-100 text-[#070707] font-sans font-semibold text-sm px-6 py-2.5 rounded-lg transition-colors shadow-[0_0_20px_rgba(255,255,255,0.15)] inline-block">
              Register Now
            </a>
          </div>
        ...
        <div className="fixed inset-0 z-[60] flex lg:hidden">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-[85%] max-w-[350px] bg-[var(--color-surface)] border-l border-white/10 flex flex-col px-6 py-8 animate-in slide-in-from-right duration-300">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="#" onClick={(e) => handleNavClick(e, 'about')} className="flex items-center justify-between bg-[var(--color-bg-dark)] border border-white/5 rounded-2xl px-6 py-4 group hover:border-[var(--color-primary)] transition-colors">
                <span className="font-sans text-lg font-medium text-white tracking-wide">ABOUT</span>
                <ChevronRight className="w-5 h-5 text-white/50 group-hover:text-white transition-colors" />
              </a>
              <a href="#" onClick={(e) => handleNavClick(e, 'events')} className="flex items-center justify-between bg-[var(--color-bg-dark)] border border-white/5 rounded-2xl px-6 py-4 group hover:border-[var(--color-primary)] transition-colors">
              ...
              <a href="#" onClick={(e) => handleNavClick(e, 'schedule')} className="flex items-center justify-between bg-[var(--color-bg-dark)] border border-white/5 rounded-2xl px-6 py-4 group hover:border-[var(--color-primary)] transition-colors">
            ...
            <div className="mt-auto flex flex-col gap-6">
              <a href="#" onClick={(e) => handleNavClick(e, 'events')} className="flux-btn-primary w-full group flex justify-center items-center">
